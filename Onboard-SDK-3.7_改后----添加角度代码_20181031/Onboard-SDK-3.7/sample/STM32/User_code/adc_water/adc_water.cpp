...
/*
 /落水检测 
 /GPIOA_4 GPIO_Mode_IN 
 /通道高电平时飞机为落水状态
*/

bool Falling_water_detection()
{
...
/*
 /推进器状态检测 
 /GPIOA_5 GPIO_Mode_IN
 /通道为高电平时接收到飞控的推进器启动指令
*/
bool Propeller_channel_detection()
{
  Water_sensor_2=GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5);
	if(Water_sensor_2 == 1)
	{
//		printf("推 进 器: 启动\r\n");
		return true;
